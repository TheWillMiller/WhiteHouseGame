...
- Game asset: public/models/white-house-residence-v1.glb, 89,708 triangles, 8,954,500 bytes. Main residence only. Both wings remain in the downloaded archive for a future coherent layout pass; the current game's wings and ballroom construction remain authored geometry.
