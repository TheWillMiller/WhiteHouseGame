...
export function buildWorksite(g:T.Group):Worksite{
 const crane=new T.Group();crane.position.set(106,0,-8);crane.name='Working tower crane';g.add(crane);
 ...
 const digger=new T.Group();digger.position.set(106,0,48);digger.name='Working excavator';g.add(digger);
