import {carveOpenings} from './carve-openings.mjs';
...
for(const tex of root.listTextures()){
 ...
 const image=sharp(tex.getImage()).resize(base?1536:normal?768:256,base?1536:normal?768:256,{fit:'inside',withoutEnlargement:true});
